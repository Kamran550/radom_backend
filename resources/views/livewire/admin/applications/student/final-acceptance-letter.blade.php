...
<body>
    ...
    <div class="content-wrapper">
        <div class="info-cell">
            <table class="info-table">
                <tr>
                    <td class="label-col">Student Number</td>
                ...
                <tr>
                    ...
                    <td class="value-col">{{ $student->study_language === 'EN' ? 'English' : 'Turkish' }}</td>
                </tr>
                <tr>
                    <td class="label-col">Education Type</td>
                    <td class="value-col">On-site Education</td>
                </tr>
                <tr>
                    <td class="label-col">Scholarship Status</td>
                    <td class="value-col">{{ $student->scholarship_status . ' Scholarship' ?? '75% Scholarship' }}
                    </td>
                </tr>
                <tr>
                    <td class="label-col">Class</td>
                    <td class="value-col">Freshman ({{ $student->current_course ?? '1st' }} Grade)</td>
                </tr>
                <tr>
                    <td class="label-col">Date of Registration</td>
    ...
    <div class="body-text">
        ...
        No disciplinary action has been recorded.
    </div>
    ...
    <table class="signature-stamp-table">
        <tr>
            <td class="sig-cell">
                ...
                <div class="sig-title">Rector</div>
            </td>
        </tr>
    </table>
