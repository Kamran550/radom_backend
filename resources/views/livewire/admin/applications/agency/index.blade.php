                            ...
                            <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                                ...
                                <td class="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-center">
                                    <div class="flex items-center justify-center gap-1 sm:gap-2">
                                        <a href="{{ route('admin.applications.agency.show', ['agency' => $app->id]) }}" class="inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 bg-[#fdf2f2] hover:bg-[#f5e6e6] text-[#6E0C0C] text-xs font-medium rounded-md transition duration-150 ease-in-out">
