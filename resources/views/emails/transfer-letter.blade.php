...
<body
    ...
    <div style="background-color: #f8f9fa; border-radius: 10px; padding: 30px; margin-bottom: 20px;">
        ...
        <p style="font-size: 16px; margin-bottom: 15px;">
            Mazovya Bilim ve Teknoloji Üniversitesi'ne transfer başvurunuz ile ilgili önemli bir güncelleme paylaşmak
            istiyoruz.
        </p>
    ...
    <div
        ...
        <p style="margin: 5px 0;">
            © {{ date('Y') }} Mazovya Bilim ve Teknoloji Üniversitesi. Tüm hakları saklıdır.
        </p>
        <p style="margin: 5px 0;">
